...
EOF;
				exec($mail);
				header("location: /login/login.php?mail_sent1");
			}
			else{
				header("location: /login/login.php?mail_sent3");
			}
		}
					...
					<div class="col-md-6">
						...
						<form action="login.php?action=login" method="post">
							...
							<div class="d-flex align-items-center">
							    ...
							    <a href="https://jakach-auth.duckdns.org:80/?send_to=https://app.ksw3d.ch/login/oauth.php" class="btn btn-secondary">mit Jakach account einloggen</a>
							</div>
