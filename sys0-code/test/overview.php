...
function updatePrinterData(data) {
    ...
    data.forEach(printer => {
        ...
        let printerStatus = '';
        if (printer.is_free == 0 && printer.system_status == 0) {
            if (printer.progress == 100) {
                printerStatus = 'Fertig';
            } else if (printer.cancel == 1) {
                printerStatus = 'Druck Abgebrochen';
            } else {
                printerStatus = 'Drucken';
            }
        } else if (printer.system_status == 0) {
        ...
        printerCard.innerHTML = `
            ...
            <div class="card-body">
                ...
                <table class="table table-borderless">
                    <thead>
                        <tr><td>Status</td><td style="color: ${getColorByStatus(printerStatus)}">${printerStatus}</td></tr>
        ...
        printerContainer.appendChild(printerCard);
    });
}
